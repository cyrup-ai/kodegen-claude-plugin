...
- use `mcp__plugin_kodegen_kg__fs_edit_block` to modify the $1 task file if incomplete or lacking in any way
- use `mcp__plugin_kodegen_kg__fs_delete_file` to delete the $1 task file if it's a perfect 10/10
