---
argument-hint: number_agents [number_agents], additional_context [additional_context]
...
Identify $1 task files to delegate execution in parallel (or N numer < $1 if less than $1 exist)
